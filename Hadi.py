...
def vm (m_vm = 5 , g=9.8, d_vm_x=None, d_vm_y=None):
...
def ta (m_ta = 0.65 , g=9.8, d_ta_x=None, d_ta_y=None):
...
def Detoid (m_Detoid = 1.2 ,g = 9.8  , d_Detoid_x = None , d_Detoid_y = None):
...
def biceps(m_bi=2, g=9.8, d_bi_x=None, d_bi_y=None, direction="left" or "right"):
...
tbly = biceps(d_bi_y=0.3 , direction="left")

print("############################################################")

tbrx = biceps(d_bi_x=0.4)
...
tbry = biceps(d_bi_y=0.3 , direction="right")
